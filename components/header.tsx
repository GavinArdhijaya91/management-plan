        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/dashboard" className="flex items-center gap-2">
              <div
                className={cn(
                  ...
                  variant === 'monochrome' ? 'bg-zinc-950' : 'bg-blue-600',
                )}
              >
              ...
              <span
                className={cn(
                  'hidden text-gray-900 md:inline',
                  variant === 'monochrome' ? 'font-serif text-lg font-semibold' : 'font-bold',
                )}
              >
                Siapin
              </span>
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <div className="relative">
                ...
                {notificationOpen && (
                  <div className="absolute right-0 top-12 w-80 rounded-2xl border border-zinc-200 bg-white p-3 shadow-xl">
              ...
              <div className="relative">
                <button
                  ...
                  className="min-h-11 min-w-11 rounded-lg p-2 transition-colors hover:bg-gray-100"
                >
                ...
                {profileOpen && (
                  <div className="absolute right-0 top-12 w-56 rounded-2xl border border-zinc-200 bg-white p-2 shadow-xl">
                    <div className="border-b border-zinc-100 px-3 py-2">
                      <p className="text-sm font-semibold">Bu Rina</p>
              ...
              <button
                onClick={logout}
                aria-label={dictionary.header.logout}
                className="hidden min-h-11 min-w-11 p-2 hover:bg-gray-100 rounded-lg transition-colors md:flex md:items-center md:justify-center"
              >
          ...
          {mobileMenuOpen && (
            <nav
              ...
              aria-label={dictionary.header.mobileNavigation}
            ...
            >
              ...
              <Link
                href="/profil"
                onClick={() => setMobileMenuOpen(false)}
                className="min-h-11 rounded-lg px-3 py-2.5 text-left text-gray-600 transition-colors hover:bg-gray-100 hover:text-zinc-950"
              >
