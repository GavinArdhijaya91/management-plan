...
export default async function CommunityPage({
  ...
  await requireActiveWorkspace('/community')
  const params = await searchParams
  const categoryId = /^\d+$/.test(params.category ?? '') ? Number(params.category) : null
  ...
  if (categoryId !== null) moreParams.set('category', String(categoryId))
