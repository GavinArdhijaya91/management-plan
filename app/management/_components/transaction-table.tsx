...
import { formatTransactionDate } from '@/app/management/_domain/transaction-aggregate'
  ...
  if (transactions.length === 0) {
    ...
    return (
      <section className="app-card px-5 py-14 text-center" aria-live="polite">
        ...
        <h2 className="mt-4 font-serif text-xl font-semibold text-zinc-950">
          {hasTransactions ? 'Transaksi tidak ditemukan' : 'Belum ada transaksi'}
        </h2>
        <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-zinc-500">
          {hasTransactions
            ? 'Coba ubah kata pencarian, tipe transaksi, atau periode yang dipilih.'
            : 'Tambahkan transaksi pertama untuk mulai membaca kondisi keuangan usaha.'}
        </p>
