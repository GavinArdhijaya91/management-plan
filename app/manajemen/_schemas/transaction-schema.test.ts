...
describe('transactionSchema', () => {
  it('menerima transaksi penjualan yang valid', () => {
    expect(transactionSchema.safeParse({ date: '2026-07-22', type: 'Penjualan', amount: '200000', modal: '120000' }).success).toBe(true)
  })
  ...
  it('menolak modal penjualan yang melebihi jumlah', () => {
    const result = transactionSchema.safeParse({ date: '2026-07-22', type: 'Penjualan', amount: '100000', modal: '120000' })
